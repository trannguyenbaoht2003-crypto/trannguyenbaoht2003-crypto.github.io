    ...
    <main id="main-content">
      ...
      <section className="community-source-section" id="community-sources">
        ...
        <div className="automation-watch">
          <div className="automation-status"><span className="live-dot" /><div><span className="eyebrow">EVIDENCE V3 · KIỂM DUYỆT TỰ ĐỘNG ĐANG BẬT</span><h3>Chỉ đăng khi bằng chứng vượt đủ hàng rào an toàn</h3></div></div>
          <p>Hai đường được chấp nhận: <b>Hai nguồn độc lập</b> cùng nêu tổ hợp, hoặc <b>Nguồn uy tín + phản hồi tích cực</b>. Evidence v3 chỉ tạo chữ ký khi có đúng một tướng, ít nhất một lõi và hai trang bị khớp ID/ảnh trong client hiện hành.</p>
          ...
          <a className="review-workbench-link" href="/review/">Mở bảng duyệt Evidence v3.1 <ExternalIcon /></a>
          ...
          <small className="automation-updated">Đối chiếu gần nhất: {formatSourceDate(communityModerationStats.generatedAt)} · Theo dõi {communityWatchStats.queryCount} nhóm truy vấn công khai. Evidence v3: {communityWatchStats.evidenceV3.candidateCount} nguồn v3 · {communityWatchStats.evidenceV3.publicImageEvidenceCount} ảnh đã băm · {communityWatchStats.evidenceV3.imageReviewQueueCount} chờ đối chiếu ảnh · {communityWatchStats.evidenceV3.translationReviewQueueCount} chờ đối chiếu bản dịch.</small>
        </div>
